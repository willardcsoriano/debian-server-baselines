...
- **Claude Code CLI** (`claude`) — installed via `npm install -g @anthropic-ai/claude-code`. Explicit exception to the no-global-npm rule; Anthropic ships the CLI this way.
